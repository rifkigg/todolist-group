                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div id="assignment" class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <svg xmlns="http://www.w3.org/2000/svg" class="d-none" width="16"
                                    height="16">
                                            ...
                                            @if ($task->count() > 0)
                                                <tr>
                                                    ...
                                                    <td title="{{ $task->priority->name ?? ' ' }}" style="">
                                                        <img src="{{ asset($task->priority->icon) }}"
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu"
                                                                ...
                                                                @else
                                                                @endif
                                                                @if (auth()->user()->role && in_array('pauseTask', auth()->user()->role->permissions->pluck('name')->toArray()))
                                                                <li>
                                                                ...
                                                                @else
                                                                @endif
                                                                @if (auth()->user()->role && in_array('stopTask', auth()->user()->role->permissions->pluck('name')->toArray()))
                                                                <li>
                                                                ...
                                                                @else
                                                                @endif
                                                                @if (auth()->user()->role && in_array('showTaskInDashboard', auth()->user()->role->permissions->pluck('name')->toArray()))
                                                                <li>
